...
import { fnStorePenjaminan } from "./penjaminanFn";
...
export default function CreateSubrogasi() {
	...
	const handleChangeNPWPS = e => {
		...
		if (numericValue.length <= 15) {
			setValueNPWP(rawValue); // Update the state with the formatted NPWP value
		}
	...
	return (
		<>
			<Container fluid id="create-subrogasi-page">
				<Row>
					<CardComponent title="Create Subrogasi" type="create" needFooter>
						<Form onSubmit={handleSubmit}>
							...
							<Row className="gx-2">
								...
								<Col>
									<InputDateComponent labelXl="12" customLabelFrom={""} formGroupClassName={"dateBirth"} startDate={formData[objectName[0]]} onChangeStartDate={e => handleChange(objectName[0], e)} />
								</Col>
							</Row>
							<Row>
								<Col>
							...
							<Row>
								<Col>
									<InputDropdownComponent
										...
										name="Provinsi"
										onChange={e => handleChange("provinsi", e.target.value === "true")}
										formGroupClassName="gx-3"
									/>
								</Col>
							</Row>
							...
							<Row>
								<Col>
									<InputComponent
										...
										labelXl="3"
										value={formData.nilaiPenjaminan}
										name="nilaiPenjaminan"
										onChange={e => handleChange("nilaiPenjaminan", e.target.value)}
										formGroupClassName="gx-2"
										placeholder={"0"}
									/>
								</Col>
							...
							<Row>
								...
								<Col style={{ paddingLeft: "40px" }}>%</Col>
							</Row>
							<Row>
								<Col>Tgl Mulai Kredit</Col>
								<Col lg={10} style={{ paddingLeft: "128px" }}>
									<InputDateComponent
										labelXl="12"
										customLabelFrom={""}
										formGroupClassName={"startDateCredit"}
										startDate={formData[objectName[1]]}
										// label={"Tgl Mulai Kredit"}
